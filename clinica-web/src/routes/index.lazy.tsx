		...
		<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
			<div>
				...
				<p className="text-xl text-white mb-8">
					Ofrecemos tratamientos personalizados de fisioterapia con un enfoque integral para tu salud y
					recuperación.
				</p>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12">
						...
						<p className="text-gray-600 max-w-2xl mx-auto">
							Ofrecemos una amplia gama de tratamientos especializados para ayudarte a recuperar tu movilidad y calidad
							de vida.
						</p>
					</div>
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<div className="bg-gray-50 rounded-lg p-6 hover:shadow-lg transition-shadow duration-200">
							...
							<p className="text-gray-600">
								Técnicas especializadas para el tratamiento de lesiones musculoesqueléticas.
							</p>
						</div>
							...
							<div className="w-12 h-12 bg-primary rounded-lg flex items-center justify-center mb-4">
								<svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
									<path
										...
										strokeLinejoin="round"
										strokeWidth="2"
										d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"
									></path>
								</svg>
							</div>
					...
					<div className="grid lg:grid-cols-2 gap-16 items-start">
						<div className="relative">
							<div className="text-center lg:text-left mb-8">
								<h3 className="text-3xl font-bold text-gray-900 mb-4">Cuidado Integral para tu Salud</h3>
							</div>
							...
							<div className="space-y-6">
								<div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl hover:shadow-md transition-shadow duration-200 border-l-4 border-primary">
									<div className="flex items-start space-x-4">
										...
										<div>
											<h4 className="font-semibold text-gray-900 mb-2">Evaluación Personalizada</h4>
											<p className="text-gray-600 text-sm leading-relaxed">
												Análisis completo de tu condición física para desarrollar un plan de tratamiento específico para
												tus necesidades.
											</p>
										</div>
									</div>
								...
								<div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl hover:shadow-md transition-shadow duration-200 border-l-4 border-primary">
									<div className="flex items-start space-x-4">
										...
										<div>
											<h4 className="font-semibold text-gray-900 mb-2">Técnicas Avanzadas</h4>
											<p className="text-gray-600 text-sm leading-relaxed">
												Utilizamos terapia manual, electroterapia y ejercicios terapéuticos basados en evidencia
												científica.
											</p>
										</div>
									</div>
								...
								<div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl hover:shadow-md transition-shadow duration-200 border-l-4 border-primary">
									<div className="flex items-start space-x-4">
										...
										<div>
											...
											<p className="text-gray-600 text-sm leading-relaxed">
												Monitoreo constante de tu progreso con ajustes personalizados en cada sesión.
											</p>
										</div>
									</div>
								</div>
								...
								<div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl hover:shadow-md transition-shadow duration-200 border-l-4 border-primary">
									<div className="flex items-start space-x-4">
										...
										<div>
											<h4 className="font-semibold text-gray-900 mb-2">Atención Empática</h4>
											<p className="text-gray-600 text-sm leading-relaxed">
												Profesionales comprometidos con tu bienestar, brindando apoyo y motivación en cada etapa.
											</p>
										</div>
									</div>
								</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						<h2 className="text-4xl font-bold text-gray-900 mb-4">
							Lo que <span className="text-primary">nuestros</span> clientes tienen que decir
						</h2>
						<p className="text-lg text-gray-600">
							Testimonios <span className="text-primary font-semibold">reales</span> de clientes frecuentes
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						<div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
							...
							<p className="text-gray-600 text-sm leading-relaxed">
								"Excelente atención profesional. Después de mi lesión de rodilla, el tratamiento personalizado me ayudó
								a recuperar completamente mi movilidad."
							</p>
						</div>
						...
						<div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
							...
							<p className="text-gray-600 text-sm leading-relaxed">
								"Como deportista, necesito un cuidado especializado. Aquí encontré profesionales que entienden las
								demandas del alto rendimiento."
							</p>
						</div>
						...
						<div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
							<div className="flex items-center mb-4">
								...
								<div className="ml-3">
									...
									<p className="text-sm text-gray-500">Recuperación post-cirugía</p>
								</div>
							</div>
							<p className="text-gray-600 text-sm leading-relaxed">
								"El seguimiento continuo y la dedicación del equipo fueron fundamentales en mi proceso de
								rehabilitación. Muy recomendado."
							</p>
						</div>
					</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						<div className="text-center group">
							<div className="relative mb-6">
								<div className="w-32 h-32 mx-auto bg-gradient-to-br from-gray-200 to-gray-300 rounded-full flex items-center justify-center overflow-hidden">
									<img
							...
							<h3 className="text-xl font-semibold text-gray-900 mb-2">test text</h3>
							<p className="text-primary font-medium mb-2">Fisioterapeuta Principal</p>
						...
						<div className="text-center group">
							...
							<h3 className="text-xl font-semibold text-gray-900 mb-2">test text</h3>
							<p className="text-primary font-medium mb-2">Especialista en Rehabilitación</p>
							<p className="text-sm text-gray-600 leading-relaxed">
						...
						<div className="text-center group">
							...
							<h3 className="text-xl font-semibold text-gray-900 mb-2">test text</h3>
							<p className="text-primary font-medium mb-2">Terapeuta Especializada</p>
							<p className="text-sm text-gray-600 leading-relaxed">
					...
					<div className="mt-16 bg-gray-50 rounded-2xl p-8">
						<div className="text-center">
							<h3 className="text-2xl font-bold text-gray-900 mb-4">Comprometidos con tu Recuperación</h3>
							<p className="text-gray-600 max-w-3xl mx-auto leading-relaxed">
								Nuestro equipo multidisciplinario trabaja en conjunto para brindarte la mejor atención posible. Cada
								profesional aporta su experiencia y conocimiento especializado para garantizar
								<span className="text-primary font-semibold"> resultados efectivos</span> en tu proceso de
								rehabilitación.
							</p>
						</div>
					</div>
