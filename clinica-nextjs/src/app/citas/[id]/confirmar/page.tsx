...
import { CheckCircle2, XCircle, Loader2, Calendar, Clock, User, Stethoscope } from "lucide-react";
...
export default function ConfirmarCitaPage() {
	...
	const handleConfirmar = async () => {
		...
		try {
			const apiUrl = process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:3001/api";
			const response = await fetch(`${apiUrl}/citas/${idCita}/confirmar?token=${token}`, {
				method: "POST",
				headers: {
			...
			setError(err.message || "Error al confirmar la cita. Por favor, intente nuevamente.");
		} finally {
			setProcessing(false);
		}
	};
			...
			<div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
				<div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
					...
					<p className="text-gray-600 dark:text-gray-300 mb-6">
						Su asistencia ha sido confirmada exitosamente. Le esperamos en la fecha y hora programada.
					</p>
					{citaData && (
						<div className="bg-blue-50 dark:bg-gray-700 rounded-lg p-4 mb-6 text-left">
							<p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
								<strong>Fecha:</strong> {new Date(citaData.fechaCita).toLocaleDateString("es-ES", {
									weekday: "long",
									year: "numeric",
									month: "long",
									day: "numeric",
							...
							<p className="text-sm text-gray-600 dark:text-gray-300">
								<strong>Hora:</strong> {new Date(citaData.fechaCita).toLocaleTimeString("es-ES", {
									hour: "2-digit",
									minute: "2-digit",
								})}
							</p>
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
			<div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 max-w-2xl w-full">
				...
				<div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-700 rounded-xl p-6 mb-6 border border-blue-200 dark:border-gray-600">
