...
export default function EditCosent(){
    const mock = {
        id: 1,
         cedula: "3-9481-3921", 
        paciente: "Luis angel", 
        fechaCreacion: new Date(2025, 5, 2), 
        doctor: "Dra. María García", 
        tratamiento: "Analgesicos fuertes"
    }
    return(
      ...
      <Card className="bg-card shadow-sm">
        ...
        <h2 className="text-lg lg:text-2xl font-semibold text-text-primary">
          ...
          <CardDescription>Editar el consentimiento de un paciente</CardDescription>
        </CardHeader>
        <CardContent>
          <Suspense fallback={<div>loading...</div>}>
          <NewConsent consent={mock} isEditing/>
          </Suspense>
        </CardContent>
      </Card>
    </div>
