        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center sm:px-6 lg:px-8 h-20">
                ...
                <div className="flex items-center  ">
                    <Link href={'/'} className=" text-2xl text-black font-semibold">Clinica Esteban Porras</Link>
                </div>
                ...
                <div className="md:hidden">
                    ...
                    <li>
                        ...
                        <SignedOut>
                        <li>
                            <Link href="/login" className="px-4 py-2 bg-primary text-white border border-primary rounded-lg ">
                        Iniciar Sesión
                    </Link>
                        </li>
                    
                    <li>
                        <Link href="/signup" className="px-4 py-2 bg-primary text-white rounded-lg ">
                        Registrarse
                    </Link>
                    </li>
